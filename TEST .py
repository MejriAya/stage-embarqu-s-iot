...
def calculate_calibration_sum(text):
    total_sum = 0  # Initialisation de la somme totale
    ...
    for idx, line in enumerate(lines, start=1):
        ...
        # Si la ligne contient au moins un chiffre
        if len(digits) >= 1:
            # Si un seul chiffre est trouvé, le doubler
            if len(digits) == 1:
            ...
            # Combiner le premier et le dernier chiffre pour former un nombre à deux chiffres
            ...
            print(f"Ligne {idx} : {line} → Valeur d'étalonnage : {calibration_value}")
        else:
            # Si la ligne ne contient pas de chiffres
            print(f"Ligne {idx} : {line} → Pas de valeur d'étalonnage valide")
    
    return total_sum

# Calculer la somme et afficher les résultats
result = calculate_calibration_sum(text)
print("\nSomme des valeurs d'étalonnage :", result)
